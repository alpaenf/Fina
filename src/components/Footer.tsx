      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row justify-between items-center">
        <div className="mb-6 md:mb-0 text-center md:text-left">
          <a
            ...
            className="font-headline-sm text-2xl tracking-tight text-white mb-2 block hover:text-accent transition-colors"
          >
        ...
        <div className="flex space-x-6">
          <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/80 hover:bg-accent hover:text-white transition-all duration-300">
